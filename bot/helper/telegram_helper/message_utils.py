...
def update_all_messages():
    ...
    msg += f"<b>🖥️ ℂℙ𝕌 :</b> <code>{psutil.cpu_percent()}%</code>" \
           f" <b>🧮 ℝ𝔸𝕄 :</b> <code>{psutil.virtual_memory().percent}%</code>" \
           f" <b>💿 𝔻𝕀𝕊𝕂 :</b> <code>{psutil.disk_usage('/').percent}%</code>"
    with download_dict_lock:
        ...
        msg += f"\n<b>♻️ 𝔽ℝ𝔼𝔼 :</b> <code>{free}</code> | <b>🥱 𝕆ℕ :</b> <code>{currentTime}</code>\n<b>𝔻𝕃 :</b> <code>{dlspeed}/s</code> 🔻 | <b>𝕌𝕃 :</b> <code>{ulspeed}/s</code> 🔺\n"
    with status_reply_dict_lock:
...
def sendStatusMessage(msg, bot):
    ...
    progress += f"<b>🖥️ ℂℙ𝕌 :</b> <code>{psutil.cpu_percent()}%</code>" \
           f" <b>🧮 ℝ𝔸𝕄 :</b> <code>{psutil.virtual_memory().percent}%</code>" \
           f" <b>💿 𝔻𝕀𝕊𝕂 :</b> <code>{psutil.disk_usage('/').percent}%</code>"
    with download_dict_lock:
        dlspeed_bytes = 0
